...
namespace Test.DatahouseService
{
    ...
    /// <summary>
    ///这是 TimeUtilTest 的测试类，旨在
    ///包含所有 TimeUtilTest 单元测试
    ///</summary>
    [TestClass()]
    public class TimeUtilTest
    {
        ...
        ///</summary>
        [TestMethod()]
        public void TimeUtilConstructorTest()
        {
            TimeUtil target = new TimeUtil();
        ...
        public void GetMillisecondsTest()
        {
            ...
            double actual; 
            actual = TimeUtil.GetMilliseconds(date);
            TestContext.WriteLine("*************1************");
            TestContext.WriteLine(actual.ToString());
            TestContext.WriteLine(((long)actual).ToString());
