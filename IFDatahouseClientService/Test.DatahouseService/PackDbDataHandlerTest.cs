...
namespace Test.DatahouseService
{
    ...
    /// <summary>
    ///这是 PackDbDataHandlerTest 的测试类，旨在
    ///包含所有 PackDbDataHandlerTest 单元测试
    ///</summary>
    [TestClass()]
    public class PackDbDataHandlerTest
    {
        ...
        public void WritePackItemViewToFileByTest()
        {
            ...
            bool actual;
            actual = target.WritePackItemViewToFileBy(startTime, endTime, file);
