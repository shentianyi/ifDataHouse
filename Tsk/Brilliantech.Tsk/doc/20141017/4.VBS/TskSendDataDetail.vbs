...
For i=0 To UBound(userTskEmail,1)-1
	...
	objConnection.connectionString = "Provider = SQLOLEDB;Data Source=SVCNJD01\EWAYHR;Initial Catalog=Leoni_Tsk_JN;Persist Security Info=True;User ID=sa;Password=leoni123@"
	...
	If rowCount>0 Then
		...
		oMessage.Configuration.Fields.Item("http://schemas.microsoft.com/cdo/configuration/smtpserver") = "cn5casarray.leoni.local"
		oMessage.Configuration.Fields.Item("http://schemas.microsoft.com/cdo/configuration/sendusername") = "func4573"
		oMessage.Configuration.Fields.Item("http://schemas.microsoft.com/cdo/configuration/sendpassword") = "leoni123@"
